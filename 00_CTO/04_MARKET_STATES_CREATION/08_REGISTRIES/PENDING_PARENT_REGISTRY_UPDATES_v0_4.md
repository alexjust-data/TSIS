...
```text
The current graph predates CURRENT_STATUS_AND_HANDOFF_v0_28, roadmap v0_17,
the consolidated transient-snapshot lineage, the TA-3 preregistered sample,
the population-target PIT recovery branch and the float source-audit branch.
Current graph answers can still point to superseded stages.
```

Changed paths include:

```text
00_CTO/04_MARKET_STATES_CREATION/CURRENT_STATUS_AND_HANDOFF_v0_28.md
00_CTO/04_MARKET_STATES_CREATION/DAILY_ELIGIBLE_UNIVERSE_SELECTOR_AND_BINDING_CONSUMPTION_CONTRACT_v0_1.md
00_CTO/04_MARKET_STATES_CREATION/TRADING_ACTIVITY_AB_DENOMINATOR_DAILY_ELIGIBLE_UNIVERSE_RECONCILIATION_READOUT_v0_1.md
00_CTO/04_MARKET_STATES_CREATION/TRADING_ACTIVITY_HANDOFF_AND_ROADMAP_LINEAGE_CONSOLIDATION_v0_1.md
