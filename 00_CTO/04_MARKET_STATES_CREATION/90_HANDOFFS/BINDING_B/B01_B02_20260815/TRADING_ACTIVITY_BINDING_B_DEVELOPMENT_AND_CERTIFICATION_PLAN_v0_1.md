...
```text
draft = PREPARED_NOT_FROZEN
blocking decisions = B02-D01..B02-D12 OPEN
...
B-02 exact specification              = DRAFT_PREPARED_NOT_FROZEN_12_BLOCKERS_OPEN
...
The next safe action is to review and close `B02-D01..B02-D12`, run an
independent scientific consistency review and obtain a separate explicit human
B-02 freeze. No Python implementation or runtime launch is authorized by this
plan.
