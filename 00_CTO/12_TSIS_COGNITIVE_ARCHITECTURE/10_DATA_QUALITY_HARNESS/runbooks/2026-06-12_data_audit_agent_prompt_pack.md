...
EstÃ¡s trabajando en TSIS.
  ...
  1. Ejecuta:
     ...
     git -C C:\TSIS_Data branch --show-current
  ...
  4. No trabajes sobre `docs/update-00-cto-readme-20260611`.
  5. No hagas push directo a main.
  6. Al terminar, haz:
     git -C C:\TSIS_Data add -A
     git -C C:\TSIS_Data commit -m "docs: complete reference audit dossier"
  ...
  - inspection_dossiers/reference/reference_inspection_readout_v0_1.md
  - inspection_dossiers/reference/build_reference_inspection_pack.md
  - inspection_dossiers/reference/evidence_assets/...
  - inspection_dossiers/reference/integration_notes.md
