...
```text
E:/00_TRADING/04_Steven_Dux/Duxinator/Steven Dux - Duxinator - High Odds Penny Trading  [Hacksnation.com]/3 - Patterns And Factors  [Hacksnation.com]/transcripts/2 - Double Layer Resistance.md
```
...
visual precisa, igual que en `01_Steven_Dux/SHORT/First_Red_Day/STRATEGY.md`.
