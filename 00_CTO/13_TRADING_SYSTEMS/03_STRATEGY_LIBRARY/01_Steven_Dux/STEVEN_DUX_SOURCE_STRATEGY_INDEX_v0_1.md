...
```text
E:\TSIS_YOUTUBE\00_TRADERS\00_Steven_Dux\TRANSCRIPTS\If You Only Watch One Trading Strategy Video, Make It This\transcript.en.txt
E:\TSIS_YOUTUBE\00_TRADERS\00_Steven_Dux\TRANSCRIPTS\If You Only Watch One Trading Strategy Video, Make It This\transcript.en.md
E:\TSIS_YOUTUBE\00_TRADERS\00_Steven_Dux\TRANSCRIPTS\If You Only Watch One Trading Strategy Video, Make It This\transcript.en.srt
```
...
```text
01_Steven_Dux/SHORT/Bounce_Short/STRATEGY.md
```
...
```text
E:\00_TRADING\04_Steven_Dux\Duxinator\Steven Dux - Duxinator - High Odds Penny Trading  [Hacksnation.com]\3 - Patterns And Factors  [Hacksnation.com]
```
...
|---|---|---|
| `1 - First Red Day The advantage and disadvantage` | `01_Steven_Dux/SHORT/First_Red_Day/STRATEGY.md` | short strategy draft |
| `2 - Double Layer Resistance` | `01_Steven_Dux/SHORT/Double_Layer_Resistance/STRATEGY.md` | short strategy draft |
| `3 - Bounce Short plus Gap Up Short` | `01_Steven_Dux/SHORT/Bounce_Plus_Gap_Up_Short/STRATEGY.md` | short strategy draft |
| `4 - Gap Up Buying` | `01_Steven_Dux/LONG/Gap_Up_Buying/STRATEGY.md` | long strategy draft |
| `5 - Double Intra-day Top` | `01_Steven_Dux/SHORT/Double_Intraday_Top/STRATEGY.md` | short strategy draft |
| `6 - Parabolic Breakout and Failed Breakout` | `01_Steven_Dux/SHORT/Parabolic_Breakout_Failed_Breakout/STRATEGY.md` | short strategy draft with long/short source context |
| `7 - Dip Buying Multi-day Runner` | `01_Steven_Dux/LONG/Dip_Buying_Multi_Day_Runner/STRATEGY.md` | long strategy draft |
| `8 - The Risk Reward on Multi-day Top` | `01_Steven_Dux/SHORT/Multi_Day_Top_Risk_Reward/STRATEGY.md` | short strategy draft |
| `9 - Introduction to Float Rotation` | `01_Steven_Dux/FACTORS/Float_Rotation/FACTOR.md` | factor draft |
| `10 - Pattern Variation and its Acceptable Range` | `01_Steven_Dux/FACTORS/Pattern_Variation_Acceptable_Range/FACTOR.md` | factor draft |
...
```text
E:\00_TRADING\04_Steven_Dux\Duxinator\Steven Dux - Duxinator - High Odds Penny Trading  [Hacksnation.com]\4 - Advance Concepts  [Hacksnation.com]
```
...
|---|---|---|
| `1 - Volume Prediction Intraday` | `01_Steven_Dux/FACTORS/Volume_Prediction/FACTOR.md` | covered as part of volume prediction factor |
| `2 - Scenarios of Intraday Volume Prediction` | `01_Steven_Dux/FACTORS/Volume_Prediction/FACTOR.md` | covered as part of volume prediction factor |
| `3 - Volume Prediction Pre-Market` | `01_Steven_Dux/FACTORS/Volume_Prediction/FACTOR.md` | covered as part of volume prediction factor |
| `4 - The Gain _ Loss of Liquidity` | `01_Steven_Dux/FACTORS/Liquidity_Gain_Loss/FACTOR.md` | covered as part of liquidity state factor |
| `5 - Volume Range and Liquidity Collaboration` | `01_Steven_Dux/FACTORS/Liquidity_Gain_Loss/FACTOR.md` | covered as part of liquidity state factor |
| `6 - Identifying Neutralized Area` | `01_Steven_Dux/FACTORS/Neutralized_Area/FACTOR.md` | covered as neutralized reward/risk factor |
| `7 - Layers of Short Seller Trap` | `01_Steven_Dux/FACTORS/Short_Seller_Trap_Layers/FACTOR.md` | covered as short-covering layer risk factor |
| `8 - Characteristics of Crowded Tickers` | `01_Steven_Dux/FACTORS/Crowded_Ticker_Context/FACTOR.md` | covered as crowded ticker context and future-resistance factor |
| `9 - The Danger of Float Rotation` | `01_Steven_Dux/FACTORS/Float_Rotation/FACTOR.md` | covered as advanced float-rotation danger section |
