...
- [trades_stratified_sample_manifests_v0_1.md](referenced_docs/evidence_assets/stratified_samples/trades_stratified_sample_manifests_v0_1.md)
...
- [trades_population_readout_v0_1.md](referenced_docs/population_evidence_packs/trades_population_readout_v0_1.md)
...
- [trades_file_acceptance_readout_v0_1.md](referenced_docs/file_acceptance_evidence_packs/trades_file_acceptance_readout_v0_1.md)
...
- review / flagged:
  - [trades_review_cases_v0_1.md](referenced_docs/flagged_case_evidence_packs/trades_review_cases_v0_1.md)
- bad:
  - [trades_bad_cases_v0_1.md](referenced_docs/bad_case_evidence_packs/trades_bad_cases_v0_1.md)
- good:
  - [trades_good_cases_v0_1.md](referenced_docs/good_justification/trades_good_cases_v0_1.md)
- casepacks amplios por familia:
  - [family_casepacks_index_v0_1.md](referenced_docs/family_case_evidence_packs/family_casepacks_index_v0_1.md)
