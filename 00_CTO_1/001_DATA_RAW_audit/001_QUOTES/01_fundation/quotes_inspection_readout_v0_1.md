...
![Taxonomy distribution](images/evidence_assets/global_policy/01_taxonomy_distribution.png)
...
![Severity and root mix](images/evidence_assets/global_policy/02_severity_and_root_mix.png)
...
![Positive cross policy](images/evidence_assets/global_policy/03_positive_cross_policy.png)
...
![Integer and timestamp diagnostics](images/evidence_assets/global_policy/04_integer_and_timestamp_diagnostics.png)
...
![Open bucket diagnostics](images/evidence_assets/global_policy/05_open_bucket_diagnostics.png)
...
- [Quotes Good Cases v0.1](evidence/quotes_good_cases_v0_1.md)
- [Quotes Review Cases v0.1](evidence/quotes_review_cases_v0_1.md)
- [Quotes Bad Cases v0.1](evidence/quotes_bad_cases_v0_1.md)
- [Quotes Open Casepacks Audit v0.1](referenced_docs/quotes_open_casepacks_audit_v0_1.md)
