...
C:\TSIS_Data\00_CTO_1\003_TABLES\016\PARQUET_CONTENT_SAMPLE.md
C:\TSIS_Data\00_CTO_1\003_TABLES\017\PARQUET_CONTENT_SAMPLE.md
```
...
3. Usar `PARQUET_CONTENT_SAMPLE.md` solo para entender forma y valores de ejemplo.
