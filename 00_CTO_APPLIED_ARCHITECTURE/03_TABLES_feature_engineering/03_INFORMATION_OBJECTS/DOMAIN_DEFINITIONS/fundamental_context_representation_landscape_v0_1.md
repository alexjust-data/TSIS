# Fundamental Context - Representation Landscape v0.1

Status: `representation_landscape_v0_1`
Date: `2026-07-20`
Scope: `post_domain_definition_pre_object_admission`

Este documento revisa modelos posibles para `Fundamental Context`.
...
```text
PIT/as_of obligatorio; ratios requieren formula versionada; no usar revisiones posteriores; float PIT esta bloqueado si no hay fuente gobernada; no confundir contexto fundamental con outcome.
```
