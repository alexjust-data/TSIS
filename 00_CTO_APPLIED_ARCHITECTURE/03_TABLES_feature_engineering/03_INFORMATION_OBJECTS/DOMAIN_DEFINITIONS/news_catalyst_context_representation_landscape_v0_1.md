# News / Catalyst Context - Representation Landscape v0.1

Status: `representation_landscape_v0_1`
Date: `2026-07-20`
Scope: `post_domain_definition_pre_object_admission`

Este documento revisa modelos posibles para `News / Catalyst Context`.
...
```text
as_of obligatorio; attribution policy obligatoria; sentiment/novelty requieren modelo versionado; no usar noticias publicadas despues de t; catalyst category no es verdad sin taxonomia gobernada.
```
