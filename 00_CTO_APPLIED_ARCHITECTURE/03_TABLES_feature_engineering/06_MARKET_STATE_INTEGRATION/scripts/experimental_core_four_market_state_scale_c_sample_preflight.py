...
DEFAULT_SCOPE = (
    ...
    / "configs"
    / "experimental_core_four_market_state_scale_c_scope_v0_1.json"
)
RUN_ID_PREFIX = "experimental_core_four_market_state_scale_c_sample_preflight_v0_1"
...
def validate_authority(scope: dict[str, Any]) -> None:
    if scope.get("scope_id") != "experimental_core_four_market_state_scale_c_scope_v0_1":
...
def main(argv: list[str] | None = None) -> int:
    ...
    pre_manifest = {
        ...
        "run_dir": str(run_dir),
        "expected_scope": "freeze 120 governed-calendar Scale C contexts only if calendar, identity and source history coverage pass",
    ...
    readout_path = integration_root / "experimental_core_four_market_state_scale_c_sample_preflight_readout_v0_1.md"
