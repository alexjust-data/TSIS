...
para reconstruir sus `day_aggs_{ticker}_{year}.parquet` bajo `E:\TSIS\data\ohlcv_daily`.
...
- ticker={TICKER}\year={YYYY}\day_aggs_{TICKER}_{YYYY}.parquet
- E:\TSIS\data\ohlcv_daily\_run\download_ohlcv_daily_v1.progress.json
- _run\download_ohlcv_daily_v1.errors.csv
- E:\TSIS\data\ohlcv_daily\_run\download_ohlcv_daily_v1.ticker_audit.csv
- _run\checkpoints\{TICKER}.json
...
progress=E:\TSIS\data\ohlcv_daily\_run\download_ohlcv_daily_v1.progress.json
ticker_audit=E:\TSIS\data\ohlcv_daily\_run\download_ohlcv_daily_v1.ticker_audit.csv
PS C:\Users\AlexJ>
```
...
Qué hace
```
- recorre de nuevo E:\TSIS\data\ohlcv_daily
