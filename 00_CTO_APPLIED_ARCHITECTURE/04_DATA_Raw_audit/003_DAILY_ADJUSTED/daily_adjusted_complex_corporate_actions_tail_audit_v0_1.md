...
- `E:\TSIS\data\additional\corporate_actions\ticker_events`
- `D:\\ohlcv_daily`
...
- â€œfalta otro factor multiplicativoâ€

sino:

- â€œfalta una politica institucional de continuidad corporativa y remapâ€.
...
- â€œel codigo ignora esas filasâ€

sino:

- â€œla policy institucional aun no explicita si `SC` debe tratarse exactamente igual que `CD`, o si requiere matizâ€.
