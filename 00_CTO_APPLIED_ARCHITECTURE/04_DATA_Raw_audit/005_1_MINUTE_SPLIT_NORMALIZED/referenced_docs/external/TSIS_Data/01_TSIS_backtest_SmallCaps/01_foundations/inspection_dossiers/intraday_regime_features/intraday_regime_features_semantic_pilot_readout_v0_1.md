...
- Cuando toda la ventana vive ya en escala post-evento, o toda ella vive aun en escala pre-evento homogÃ©nea, las razones cross-session pueden permanecer casi invariantes.
...
![BXRX 2022-12](../../../../../../../images/intraday_regime_features/images/BXRX_2022_12.png)
...
- Responde a si las features de rÃ©gimen cambian de forma material cuando la comparacion entre sesiones se calcula con `raw` frente a `split_normalized`; y a si esa diferencia aparece exactamente donde la semantica del split la haria esperable.

**Lectura tecnica**

- Aqui si aparece la firma que queriamos detectar. El mes tiene `1` dias con diferencia de gap superior al `50%` y una diferencia maxima de `3897.11%`. En paralelo, `multi_session_return_3d_to_open` alcanza una divergencia maxima de `4175.48%`, lo que indica que el shock mecanico no solo contaminarÃ­a el gap overnight, sino tambien memoria multi-sesion y features de extension.

**Conclusion de auditoria**

- ConclusiÃ³n de auditorÃ­a: caso positivo fuerte. El consumidor demuestra que usar `1m raw` habria fabricado seÃ±ales de rÃ©gimen falsas, mientras que `1m_split_normalized` neutraliza esa discontinuidad.

### COSM | 2022-12

![COSM 2022-12](../../../../../../../images/intraday_regime_features/images/COSM_2022_12.png)
...
![CEI 2022-12](../../../../../../../images/intraday_regime_features/images/CEI_2022_12.png)
...
![BNGO 2025-01](../../../../../../../images/intraday_regime_features/images/BNGO_2025_01.png)
...
![EFSH 2025-01](../../../../../../../images/intraday_regime_features/images/EFSH_2025_01.png)
...
![SAVA 2023-12](../../../../../../../images/intraday_regime_features/images/SAVA_2023_12.png)
...
- ConclusiÃ³n de auditorÃ­a: caso frontera coherente. La falta de divergencia grande no contradice la semÃ¡ntica; describe una ventana donde casi no queda pasado reescalable dentro del propio mes.

### PD | 2006-03

![PD 2006-03](../../../../../../../images/intraday_regime_features/images/PD_2006_03.png)
...
![LIVE 2014-02](../../../../../../../images/intraday_regime_features/images/LIVE_2014_02.png)
...
![BXRX 2022-11](../../../../../../../images/intraday_regime_features/images/BXRX_2022_11.png)
...
- ConclusiÃ³n de auditorÃ­a: control correcto. La capa no inventa correcciones visibles donde no hay discontinuidad de escala dentro de la ventana Ãºtil del feature.

### BNGO | 2025-02

![BNGO 2025-02](../../../../../../../images/intraday_regime_features/images/BNGO_2025_02.png)
