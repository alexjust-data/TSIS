# Backtest clásico vs patter_mining
...
# Tablas de estado con data 2005-2026
...
```
Entonces en un backtest mecanico clasico el concepto y pregunta sería   
"¿La ventaja sobrevive en el tiempo? es decir, esta estrategia sobrevive en el tiempo?"   
La regla es fija siempre. La lógica nunca cambia aunque el trade dure 30 segudos.
...
Para estos resultados he de hallar la configuración más robusta con el menor grado de libertad posible para la no sobreoptimizacion.   
Pero esta parte del trabajo solo contesta a ¿funciona esta estrategia?


Lo ideal es pasar a contestar   
¿Cuál es la mejor decisión posible dentro de ese contexto?   
siendo el contexto las estrategias backtesteadas en el clasico.   
¿es así?
...
mi pregunta es como hallo primero los mejores squeezes.   
y aqui entra el conceoto de pattern mining que me has dicho... 
```
