...
La ejecucion puede usar datos, builders o backtests de modulos como SmallCaps. Eso no convierte a SmallCaps en adapter: SmallCaps mantiene su propio flujo operativo de investigacion y backtest clasico. `00_TSIS_Lab` conserva la definicion transversal del experimento.
