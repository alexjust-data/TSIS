...
```powershell
python "C:\TSIS_Data\00_TSIS_Lab\04_experiments\EXP_DAS_FRONTSIDE_DISCOVERY_0002\scripts\run_scanner_2026_qg_full_universe_monitored_v0_2.py"
```
...
```powershell
python "C:\TSIS_Data\00_TSIS_Lab\04_experiments\EXP_DAS_FRONTSIDE_DISCOVERY_0002\scripts\audit_scanner_denominator_v0_1.py" --run-root "<RUN_ROOT>"
```
...
```powershell
python "C:\TSIS_Data\00_TSIS_Lab\04_experiments\EXP_DAS_FRONTSIDE_DISCOVERY_0002\scripts\build_das_frontside_anchor_candidates_from_worklist_v0_1.py" --run-root "C:\TSIS_Data\00_TSIS_Lab\04_experiments\EXP_DAS_FRONTSIDE_DISCOVERY_0002\evidence\scanner_2026_qg_full_universe_full_v0_2_20260707T164416Z" --output-dir "C:\TSIS_Data\00_TSIS_Lab\04_experiments\EXP_DAS_FRONTSIDE_DISCOVERY_0002\evidence\scanner_2026_qg_full_universe_full_v0_2_20260707T164416Z\anchor_candidates_v0_1"
```
...
```powershell
python "C:\TSIS_Data\00_TSIS_Lab\04_experiments\EXP_DAS_FRONTSIDE_DISCOVERY_0002\scripts\render_das_frontside_anchor_candidates_v0_1.py" --overwrite
```
