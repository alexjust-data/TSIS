...
- **Scope:** corrected ticker-session coverage semantics for Daily, 1m,
  ...
  run also added a SQLite-ledger live monitor that never opens heartbeat.json
  and a persisted runtime incident control after recoverable WinError 5 stops.
...
- **Archivos afectados:** module contracts v0.1/v0.2, schema contract,
  ...
  configs v0.1/v0.2, runner, wrapper, heartbeat/ledger monitors, stop script,
  focused tests and the runtime incident register.
...
- **Archivos afectados:** `SEC_PIT_100_CASE_STRATIFIED_SCALE_GATE_READOUT_v0_1.md`; `SEC_PIT_100_CASE_OS_MULTI_EVIDENCE_SHARD_CERTIFICATION_v0_1.md`; `SEC_PIT_EXTERNAL_AUDIT_PACKAGE_CONTENTS_v0_4.md`; SEC PIT 100-case configs, builders, acquisition/storage, Company Facts reconciliation, batch/package code and dedicated tests; `01_foundations/CHANGELOG.md`; `01_TSIS_DATA_FOUNDATION/CHANGELOG.md`.
...
### GFQ-20260722-root-path-migration-data-foundation

Status: `pending_controlled_refresh`
...
```text
01_foundations_path_migration
01_TSIS_DATA_FOUNDATION_authority_surface
```

Reason:

```text
The module root was renamed from 01_TSIS_backtest_SmallCaps to 01_TSIS_DATA_FOUNDATION. Current Graphify source locations and some historical evidence may still carry the legacy path. Active agents must resolve through C:/TSIS_Data/PATH_MIGRATION_2026_07_22.md until a controlled refresh is executed.
```
...
```text
Refresh only in a dedicated window. Do not hand-edit preserved audit evidence solely to modernize paths.
```
...
01_TSIS_DATA_FOUNDATION/agent_bootstrap
```
...
```text
01_TSIS_DATA_FOUNDATION/scripts/agent05_build_market_calendar_official.py
01_TSIS_DATA_FOUNDATION/scripts/materialize_market_calendar.py
01_TSIS_DATA_FOUNDATION/scripts/materialize_expected_data_calendar.py
01_TSIS_DATA_FOUNDATION/scripts/materialize_master_daily_table.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_market_calendar_contract.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_expected_data_calendar_contract.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_master_daily_table_contract.py
01_TSIS_DATA_FOUNDATION/01_foundations/dataset_registry/outputs/market_calendar_registry_entry.yaml
01_TSIS_DATA_FOUNDATION/01_foundations/dataset_registry/outputs/expected_data_calendar_registry_entry.yaml
01_TSIS_DATA_FOUNDATION/01_foundations/dataset_registry/outputs/master_daily_table_registry_entry.yaml
01_TSIS_DATA_FOUNDATION/01_foundations/contract_registry/dataset_contracts/market_calendar_dataset_contract_v0_1.md
01_TSIS_DATA_FOUNDATION/01_foundations/contract_registry/dataset_contracts/master_daily_table_dataset_contract_v0_1.md
01_TSIS_DATA_FOUNDATION/01_foundations/canonical_schemas/outputs/market_calendar_schema_contract.md
01_TSIS_DATA_FOUNDATION/01_foundations/canonical_schemas/outputs/expected_data_calendar_schema_contract.md
01_TSIS_DATA_FOUNDATION/01_foundations/data_consumption_policies/market_calendar_consumption_policy.md
...
```text
python -m pytest C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_market_calendar_contract.py C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_expected_data_calendar_contract.py C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_master_daily_table_contract.py -q
result = 12 passed
```
...
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_daily_scanner_candidates_table_builder_v0_3.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/README.md
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/scanner_definitions/base_eligible_smallcap_denominator_v0_3.yaml
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/scanner_definitions/in_play_momentum_candidate_denominator_v0_3.yaml
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/scanner_definitions/trade_station_like_profile_v0_3.yaml
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/scanner_definitions/README.md
...
```text
Validation: python -m pytest C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_daily_scanner_candidates_table_builder_v0_3.py -q
Result: 1 passed.
...
01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/graphify/README.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/graphify/data_foundation_graph_and_table_design_protocol.md
01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md
01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_REFRESH_QUEUE.md
```
...
```text
01_TSIS_DATA_FOUNDATION/tests/conftest.py
01_TSIS_DATA_FOUNDATION/tests/_helpers/__init__.py
01_TSIS_DATA_FOUNDATION/tests/_helpers/data_foundation.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_instrument_master_contract.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_market_calendar_contract.py
01_TSIS_DATA_FOUNDATION/CHANGELOG.md
01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md
...
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/data_storage_topology_and_target_state.md
01_TSIS_DATA_FOUNDATION/CHANGELOG.md
01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md
```
...
- Added module-level test documentation under `01_TSIS_DATA_FOUNDATION/tests/`.
...
```text
01_TSIS_DATA_FOUNDATION/tests/README.md
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/README.md
01_TSIS_DATA_FOUNDATION/tests/foundations/README.md
01_TSIS_DATA_FOUNDATION/tests/pipelines/README.md
01_TSIS_DATA_FOUNDATION/tests/research/README.md
01_TSIS_DATA_FOUNDATION/tests/event_engine/README.md
01_TSIS_DATA_FOUNDATION/tests/strategy_engine/README.md
01_TSIS_DATA_FOUNDATION/tests/execution/README.md
01_TSIS_DATA_FOUNDATION/tests/rl_preparation/README.md
01_TSIS_DATA_FOUNDATION/CHANGELOG.md
01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md
```
...
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/market_state_builder_fixture_v0_1.json
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/event_state_builder_fixture_v0_1.json
01_TSIS_DATA_FOUNDATION/scripts/_state_fixture_builder.py
01_TSIS_DATA_FOUNDATION/scripts/materialize_market_state_table.py
01_TSIS_DATA_FOUNDATION/scripts/materialize_event_state_table.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_market_state_table_contract.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_event_state_table_contract.py
01_foundations/module_contracts/outputs/market_state_event_state_build_loop_runbook_v0_1.md
01_foundations/module_contracts/outputs/data_foundation_outputs_target_contract_v0_1.md
01_foundations/module_contracts/outputs/data_foundation_outputs_status_matrix_v0_1.md
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/README.md
...
01_TSIS_DATA_FOUNDATION/scripts/monitor_long_running_operation.ps1
01_TSIS_DATA_FOUNDATION/scripts/run_1m_split_normalized_materialization.ps1
01_TSIS_DATA_FOUNDATION/scripts/data_ops/clone_quotes_to_staging.ps1
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/quotes/quotes_staging_clone_runbook_v0_1.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/ohlcv_1m_split_normalized_full_universe_materialization_runbook_v0_1.md
01_TSIS_DATA_FOUNDATION/CHANGELOG.md
01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md
```
...
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/data_foundation/1m_split_normalized_full_universe_candidate/telemetry_smoke_20260627_1912/
```
...
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/data_foundation/microstructure_features_table_v0_2_candidate_controlled_25_per_role/microstructure_features_table_v0_2_candidate_window_manifest_v0_1.csv
C:/TSIS_Data/tests/test_runs/2026-06-27/data_foundation_outputs_microstructure_v0_2_controlled_candidate/
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/inspection_dossiers/microstructure_features/microstructure_candidate_controlled_visual_readout_v0_2.md
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/inspection_dossiers/microstructure_features/visual_evidence_v0_2_controlled_25_per_role/
```
...
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_daily_scanner_candidates_table_builder_v0_2.py
01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/README.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/outputs/daily_scanner_candidates_table_target_contract_v0_2.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/outputs/data_foundation_outputs_status_matrix_v0_1.md
01_TSIS_DATA_FOUNDATION/01_foundations/canonical_schemas/outputs/daily_scanner_candidates_table_schema_contract.md
01_TSIS_DATA_FOUNDATION/01_foundations/validators/outputs/daily_scanner_candidates_table_validators.md
01_TSIS_DATA_FOUNDATION/01_foundations/dataset_registry/outputs/daily_scanner_candidates_table_registry_entry.yaml
...
```text
Validation: python -m pytest C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_daily_scanner_candidates_table_builder_v0_2.py -q
Result: 1 passed.
```
...
01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/scanner_definitions/README.md
01_TSIS_DATA_FOUNDATION/01_foundations/canonical_schemas/outputs/intraday_scanner_candidates_table_schema_contract.md
01_TSIS_DATA_FOUNDATION/01_foundations/contract_registry/dataset_contracts/intraday_scanner_candidates_table_dataset_contract_v0_1.md
01_TSIS_DATA_FOUNDATION/01_foundations/data_consumption_policies/intraday_scanner_candidates_table_consumption_policy.md
01_TSIS_DATA_FOUNDATION/01_foundations/dataset_registry/outputs/intraday_scanner_candidates_table_registry_entry.yaml
...
01_TSIS_DATA_FOUNDATION/01_foundations/validators/outputs/intraday_scanner_candidates_table_validators.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/outputs/data_foundation_outputs_status_matrix_v0_1.md
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/README.md
01_TSIS_DATA_FOUNDATION/CHANGELOG.md
```
...
```text
Validation: python -m pytest C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_intraday_scanner_candidates_table_builder_v0_1.py -q
Result: 1 passed.
...
```text
01_TSIS_DATA_FOUNDATION/scripts/data_ops/audit_quotes_clone_parity.py
01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/quotes/quotes_staging_clone_runbook_v0_1.md
01_TSIS_DATA_FOUNDATION/CHANGELOG.md
```
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/graphify-out/leaf_slices/data_foundation_outputs_topology_20260705/
