...
- [intraday_regime_features_schema_contract.md](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/canonical_schemas/features/intraday_regime_features_schema_contract.md>)

Policy de consumo:

- [intraday_regime_features_consumption_policy.md](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/data_consumption_policies/intraday_regime_features_consumption_policy.md>)
