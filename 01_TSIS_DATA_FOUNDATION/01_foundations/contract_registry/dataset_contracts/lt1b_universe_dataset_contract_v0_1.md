...
Este contrato institucionaliza el universo operativo `<1B>` de `01_TSIS_DATA_FOUNDATION`.
...
- `C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\runs\backtest\market_cap_last_observed_cutoff\20260320_market_cap_last_observed_cutoff`
