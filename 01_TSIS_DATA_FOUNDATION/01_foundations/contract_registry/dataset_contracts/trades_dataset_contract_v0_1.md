...
This contract defines what `trades` is inside `01_TSIS_DATA_FOUNDATION`, which audit layers are authoritative, and how the dataset must be interpreted by research, execution, backtest and ML pipelines.
