...
- [trades_inspection_notebook_v0_1.ipynb](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/inspection_dossiers/trades/trades_inspection_notebook_v0_1.ipynb>)

Y un selector reusable:

- [trades_case_panel.py](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/inspection/trades/trades_case_panel.py>)

Ademas, la capa poblacional global ya tiene su propio notebook ejecutable:

- [trades_universe_inspection_notebook_v0_1.ipynb](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/inspection_dossiers/trades/trades_universe_inspection_notebook_v0_1.ipynb>)

Y su lectura institucional persistente:

- [trades_global_universe_readout_v0_1.md](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/inspection_dossiers/trades/trades_global_universe_readout_v0_1.md>)

y su modulo reusable:

- [trades_universe_panel.py](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/inspection/trades/trades_universe_panel.py>)
...
- [trades_sampling_strategy_v0_1.md](</C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/01_foundations/inspection_dossiers/trades/trades_sampling_strategy_v0_1.md>)
