...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\scripts\run_ohlcv_1m_quote_guarded_repair.ps1" -Workers 12 -Overwrite
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\scripts\run_ohlcv_1m_quote_guarded_repair.ps1" -SmokeOnly -Workers 4 -Overwrite
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\scripts\run_ohlcv_1m_quote_guarded_repair.ps1" -Tickers "TWG,TIRX,RVYL,SHPH" -MinYear 2026 -MaxYear 2026 -NoPromoteManifest -Workers 4 -Overwrite
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\scripts\run_ohlcv_1m_quote_guarded_repair.ps1" -RunRoot "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\runs\data_foundation\ohlcv_1m_quote_guarded\quote_guarded_YYYYMMDD_HHMMSS" -Workers 12
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\scripts\run_ohlcv_1m_quote_guarded_repair.ps1" -NoPromoteManifest
```
...
```text
C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\src\data\ohlcv_1m_quote_guarded.py
```
