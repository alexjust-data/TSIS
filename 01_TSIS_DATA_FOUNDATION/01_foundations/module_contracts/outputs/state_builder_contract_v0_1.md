...
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_market_state_intraday_quote_guarded_candidate_builder.py
...
```text
script = C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/materialize_market_state_intraday_quote_guarded_candidate.py
test = C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_market_state_intraday_quote_guarded_candidate_builder.py
