...
| universo LT1B | `C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/backtest/market_cap_last_observed_cutoff/20260320_market_cap_last_observed_cutoff/market_cap_cutoff_lt_1b_active_inactive.parquet` | `support_only` | universo de tickers LT1B usado por la consolidacion |
| repair run root | `C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/data_foundation/ohlcv_1m_quote_guarded/quote_guarded_v0_2_20260627_091838` | `lineage_only` | run broad original de repair shards |
| consolidation run root | `C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/data_foundation/ohlcv_1m_quote_guarded/quote_guarded_lt1b_consolidation_manual_20260703_094500` | `lineage_only` | consolidacion manual promovida LT1B |
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/inspection/minute/build_ohlcv_1m_quote_guarded_repairs_v0_2.py
```

Wrappers y supervision relacionados:

```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/run_ohlcv_1m_quote_guarded_repair_v0_2.ps1
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/supervise_ohlcv_1m_quote_guarded_repair_v0_2.ps1
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/validate_ohlcv_1m_quote_guarded_repair_v0_2.ps1
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/monitor_ohlcv_1m_quote_guarded_repair_v0_2.ps1
```
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/inspection/minute/consolidate_ohlcv_1m_quote_guarded_lt1b_v0_1.py
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/consolidate_ohlcv_1m_quote_guarded_lt1b_v0_1.ps1
```
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/configs/data_foundation_outputs/master_intraday_bar_table_quote_guarded_candidate_v0_2.json
```
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/preflight_master_intraday_quote_guarded_candidate.py
```
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/materialize_master_intraday_quote_guarded_candidate_sample.py
```
...
```text
C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/materialize_master_intraday_quote_guarded_candidate_scoped.py
```
