...
- Legacy root `C:/TSIS_Data/01_TSIS_backtest_SmallCaps` must resolve through `C:/TSIS_Data/PATH_MIGRATION_2026_07_22.md`.
- Semantic boundary clarified: this module owns Data Foundation, audit/certification, contracts, schemas, policies, validators, dossiers, lineage and governed data outputs. The professional backtest engine implementation belongs in `C:/TSIS_Data/02_TSIS_BACKTEST_ENGINE`.
- Preserved historical evidence rule: do not rewrite `01_research/01_auditoria_RAW_DATA`, `data`, `run` or `runs` only to modernize path strings.
...
lt1b_universe_parquet = C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/backtest/market_cap_last_observed_cutoff/20260320_market_cap_last_observed_cutoff/market_cap_cutoff_lt_1b_active_inactive.parquet
```
...
```text
powershell -NoProfile -ExecutionPolicy Bypass -File C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/scripts/run_intraday_scanner_candidates_materialization_v0_1.ps1 -StartDate 2025-01-02 -EndDate 2025-01-02 -RunId syntax_check_intraday_runner_v0_1 -RunRoot C:/tmp/tsis_intraday_runner_syntax_check -HeartbeatSeconds 5
```
...
```text
python -m pytest C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_daily_scanner_candidates_table_builder_v0_3.py -q
```
...
```text
python -m pytest C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/tests/data_foundation_outputs/test_daily_scanner_candidates_table_builder_v0_2.py -q
```
...
```text
01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/graphify-out/leaf_slices/certification_decisions_topology_20260629/
```
...
```text
01_TSIS_DATA_FOUNDATION/01_foundations/graphify-out/leaf_slices/data_foundation_outputs_topology_20260629/
```
...
one_minute_split_smoke:
  ...
  result: PASS
  run_root: C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/data_foundation/1m_split_normalized_full_universe_candidate/telemetry_smoke_20260627_1912/
...
```text
smoke_run: C:/TSIS_Data/01_TSIS_DATA_FOUNDATION/runs/data_foundation/1m_split_normalized_full_universe_candidate/split_affected_20260627_153012/
smoke_rows: 100
smoke_tickers: 1
