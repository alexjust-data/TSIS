...
$monitorCommand = 'powershell -NoProfile -ExecutionPolicy Bypass -File "C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\scripts\monitor_long_running_operation.ps1" -RunRoot "{0}" -RunId "{1}" -Compact -Watch' -f $runRoot, $RunId
$pidManifest = [ordered]@{
    run_id = $RunId
