...
CORPUS_RELATIVE_PATHS = [
    ...
    "01_TSIS_DATA_FOUNDATION/01_foundations/README.md",
...
def build_extraction(repo_root: Path) -> dict[str, Any]:
    ...
    smallcaps_local = n("01_TSIS_DATA_FOUNDATION/LOCAL_RULES.md", "SmallCaps Local Rules", "SmallCaps Local Rules", "document")
    ...
    e(smallcaps_local, foundations_graph_protocol, "references", "01_TSIS_DATA_FOUNDATION/LOCAL_RULES.md", "INFERRED", 0.75)
    e(foundations_readme, foundations_graph_protocol, "references", "01_TSIS_DATA_FOUNDATION/01_foundations/README.md", "INFERRED", 0.75)
    e(foundations_graph_protocol, foundations_root_graph, "implements", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(foundations_graph_protocol, leaf_first, "conceptually_related_to", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md", "INFERRED", 0.85)
    e(foundations_graph_protocol, build_manifest, "implements", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(foundations_graph_protocol, no_api_mode, "implements", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(foundations_graph_protocol, graph_delta, "implements", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(foundations_queue, foundations_graph_protocol, "references", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md")
    e(foundations_queue, graph_delta, "conceptually_related_to", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_REFRESH_QUEUE.md", "INFERRED", 0.85)
    e(table_graph_protocol, foundations_graph_protocol, "references", "01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/graphify/data_foundation_graph_and_table_design_protocol.md")
    e(table_graph_protocol, table_outputs, "implements", "01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/graphify/data_foundation_graph_and_table_design_protocol.md")
    e(table_graph_protocol, market_state_outputs, "implements", "01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/graphify/data_foundation_graph_and_table_design_protocol.md")
    e(table_outputs, market_state_outputs, "conceptually_related_to", "01_TSIS_DATA_FOUNDATION/01_foundations/module_contracts/graphify/data_foundation_graph_and_table_design_protocol.md", "INFERRED", 0.85)

    e(certification_graph_protocol, certification_root_graph, "implements", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(certification_graph_protocol, leaf_first, "conceptually_related_to", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md", "INFERRED", 0.85)
    e(certification_graph_protocol, build_manifest, "implements", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(certification_graph_protocol, no_api_mode, "implements", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(certification_graph_protocol, graph_delta, "implements", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md")
    e(certification_queue, certification_graph_protocol, "references", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_REFRESH_QUEUE.md")
    e(certification_queue, graph_delta, "conceptually_related_to", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_REFRESH_QUEUE.md", "INFERRED", 0.85)

    e(cto_root_graph, foundations_root_graph, "conceptually_related_to", "00_CTO/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md", "INFERRED", 0.85)
    e(foundations_root_graph, certification_root_graph, "conceptually_related_to", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md", "INFERRED", 0.85)
    ...
    e(merge_gate, foundations_root_graph, "rationale_for", "01_TSIS_DATA_FOUNDATION/01_foundations/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md", "INFERRED", 0.85)
    e(merge_gate, certification_root_graph, "rationale_for", "01_TSIS_DATA_FOUNDATION/01_research/01_auditoria_RAW_DATA/00_data_certification/GRAPHIFY_OFFICIAL_BUILD_PROTOCOL.md", "INFERRED", 0.85)
