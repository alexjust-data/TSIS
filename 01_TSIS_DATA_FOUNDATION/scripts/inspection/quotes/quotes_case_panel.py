...
REFERENCE_IDENTITY_SNAPSHOT_PATH = Path(
    r"C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\01_research\01_auditoria_RAW_DATA\00_data_certification\auditoria\reference\cache_v2\reference_identity_snapshot.parquet"
)
REFERENCE_DIVIDEND_CASE_INDEX_PATH = Path(
    r"C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\01_research\01_auditoria_RAW_DATA\00_data_certification\auditoria\reference\cache_v2\reference_dividend_case_index.parquet"
)
REFERENCE_SPLIT_CASE_INDEX_PATH = Path(
    r"C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\01_research\01_auditoria_RAW_DATA\00_data_certification\auditoria\reference\cache_v2\reference_split_case_index.parquet"
)

QUOTES_CERT_IMG_DIR = Path(
    r"C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\01_research\01_auditoria_RAW_DATA\00_data_certification\certification\quotes\img"
)
