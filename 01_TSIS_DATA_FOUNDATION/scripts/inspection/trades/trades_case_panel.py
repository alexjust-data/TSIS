...
TRADES_HISTORICAL_ASSETS_DIR = Path(
    r"C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\01_foundations\inspection_dossiers\trades\evidence_assets\historical_assets"
)
TRADES_FILE_ACCEPTANCE_CACHE_DIR = Path(
    r"C:\TSIS_Data\01_TSIS_DATA_FOUNDATION\runs\backtest\trades_v2_materialized\trades_current_cd_merged\root_cause_exports\file_acceptance_cache_lt1b"
)
