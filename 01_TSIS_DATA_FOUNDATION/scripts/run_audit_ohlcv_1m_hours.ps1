param(
    ...
    [string]$CalendarCsv = "C:\TSIS_Data\02_backtest_SmallCaps\data\reference\market_calendar_official_XNYS_20050101_20251231.csv",
    [string]$AuditDir = "C:\TSIS_Data\02_backtest_SmallCaps\runs\debug\audit_ohlcv_1m_hours",
...
$env:AUDIT_SCRIPT = "C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\audit_ohlcv_1m_hours.py"
