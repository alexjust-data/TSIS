...
METHODS = frozenset({
    "COVER_PAGE_CLASS_OS_TEXT_V0_1",
    "INLINE_XBRL_CLASS_CONTEXT_V0_1",
})


def reconcile_class_os_anchors(
    ...
    for row in observations:
        ...
        class_label = str(attributes.get("security_class_label") or "")
        key = (
    ...
    for key, rows in groups.items():
        ...
        promoted["observation_id"] = stable_id("admitted_class_os_v0_2", *key)
        promoted["quality_state"] = "ADMITTED_OS_ANCHOR"
        promoted["extraction_method"] = "RECONCILED_CLASS_TEXT_AND_INLINE_XBRL_V0_2"
        promoted["attributes"] = {
            **(chosen.get("attributes") or {}),
            "admission_policy_id": "class_os_exact_dual_extraction_agreement_v0_2",
    ...
    readout = {
        "policy_id": "class_os_exact_dual_extraction_agreement_v0_2",
