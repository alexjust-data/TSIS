...
2. `01_TSIS_backtest_SmallCaps/AGENTS.md`;
3. `01_TSIS_backtest_SmallCaps/LOCAL_RULES.md`;
4. este documento;
...
El changelog padre `01_TSIS_backtest_SmallCaps/CHANGELOG.md` sigue siendo
