# Intraday Scanner Candidates Table Schema Contract v0.1
...
```text
schema_contract_candidate_controlled_replay_not_promoted
```

## Grain

```text
one row per scanner_run_id + ticker + session_date
```
