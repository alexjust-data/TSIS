...
```powershell
& "C:\TSIS_Data\01_TSIS_backtest_SmallCaps\scripts\run_1m_split_normalized_materialization.ps1" `
  -SmokeOnly `
  -SmokeLimit 100 `
  -Mode split-affected
```
...
```powershell
$PROJECT = "C:\TSIS_Data\01_TSIS_backtest_SmallCaps"
$RUN_ROOT = "C:\TSIS_Data\01_TSIS_backtest_SmallCaps\runs\data_foundation\1m_split_normalized_full_universe_candidate\smoke_$(Get-Date -Format yyyyMMdd_HHmmss)"
