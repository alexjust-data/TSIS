...
termine y pase validacion final. Ya existe un parquet scoped candidate not-official para
`master_intraday_bar_table_v0_2_candidate_quote_guarded`, pero no hay
full-universe/promoted official dataset.
```
