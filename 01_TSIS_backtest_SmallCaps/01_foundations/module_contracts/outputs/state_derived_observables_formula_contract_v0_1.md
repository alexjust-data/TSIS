...
C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_master_daily_table.py
C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_intraday_scanner_candidates_table_v0_1.py
C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_microstructure_features_table.py
C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_regime_context_table.py
C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_short_context_table.py
...
builder = C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_master_daily_table.py
```
...
builder = C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_microstructure_features_table.py
```
...
builder = C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_short_context_table.py
```
...
builder = C:/TSIS_Data/01_TSIS_backtest_SmallCaps/scripts/materialize_regime_context_table.py
```
