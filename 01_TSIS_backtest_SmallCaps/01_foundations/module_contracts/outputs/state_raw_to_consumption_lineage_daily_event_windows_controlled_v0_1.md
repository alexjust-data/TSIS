...
| scanner definitions | `C:/TSIS_Data/01_TSIS_backtest_SmallCaps/configs/data_foundation_outputs/scanner_definitions` | `definition_only` | parametros versionados del scanner |
...
scanner_definitions_dir = C:/TSIS_Data/01_TSIS_backtest_SmallCaps/configs/data_foundation_outputs/scanner_definitions
```
