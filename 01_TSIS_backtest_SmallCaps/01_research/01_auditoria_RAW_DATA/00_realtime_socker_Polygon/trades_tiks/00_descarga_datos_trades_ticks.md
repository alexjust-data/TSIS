...
- `C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification`
...
- `C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\<RUN_ID>\inputs\tasks_trades_ticks.csv`
...
```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\205_generate_trades_ticks_tasks.py --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --mode lifecycle --cutoff 2026-03-14
```

Resultado esperado:

- `C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026\inputs\tasks_trades_ticks.csv`
...
```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\201_agent1_download_trades_ticks_realtime.py --csv C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026\inputs\tasks_trades_ticks.csv --output D:\trades_ticks_prod_2005_2026 --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --session market --concurrent 8 --task-batch-size 200 --max-retries 4 --retry-base-sleep-sec 0.75 --retry-max-sleep-sec 12.0 --resume
```
...
```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\202_agent2_validate_trades_ticks_strict.py --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --probe-root D:\trades_ticks_prod_2005_2026 --max-files 50000 --sleep-sec 15 --expected-csv C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026\inputs\tasks_trades_ticks.csv
```

Para una sola foto puntual:

```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\202_agent2_validate_trades_ticks_strict.py --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --probe-root D:\trades_ticks_prod_2005_2026 --max-files 50000 --sleep-sec 15 --one-shot --expected-csv C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026\inputs\tasks_trades_ticks.csv
```
...
- `C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\<RUN_ID>\agent03_trades_ticks_outputs`
...
```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\203_agent3_monitor_trades_ticks_coverage.py --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --expected-csv C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026\inputs\tasks_trades_ticks.csv --interval-sec 15
```

Comando puntual:

```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\203_agent3_monitor_trades_ticks_coverage.py --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --expected-csv C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026\inputs\tasks_trades_ticks.csv --one-shot
```
...
```powershell
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\204_agent4_supervisor_trades_ticks.py --run-id trades_ticks_prod_2005_2026 --run-dir C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\trades_ticks_prod_2005_2026 --interval-sec 15 --stall-sec 180
```
