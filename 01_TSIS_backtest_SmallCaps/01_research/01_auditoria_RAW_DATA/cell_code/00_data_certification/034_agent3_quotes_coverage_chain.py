...
EVENTS_CSV = Path(globals().get("EVENTS_CSV", r"C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\quotes_agent_strict_events_current.csv"))
RETRY_QUEUE_CSV = Path(globals().get("RETRY_QUEUE_CSV", r"C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\retry_queue_quotes_strict_current.csv"))
OFFICIAL_LIFECYCLE_CSV = Path(globals().get("OFFICIAL_LIFECYCLE_CSV", r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\official_lifecycle_compiled.csv"))

OUT_DIR = Path(globals().get("OUT_DIR", r"C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\agent03_outputs"))
