...
VALIDATOR_VERSION = "daily_v2_validate_file/0.2.0"
            ...
            metrics.update(
                {
                    ...
                    "vw_outside_range_abs_min": json_ready(vw_problem_df["vw_outside_range_abs"].min() if not vw_problem_df.empty else None),
                    "vw_outside_range_abs_median": json_ready(vw_problem_df["vw_outside_range_abs"].median() if not vw_problem_df.empty else None),
                    ...
                    "vw_outside_range_pct_of_span_median": json_ready(vw_problem_df["vw_outside_range_pct_of_span"].median() if not vw_problem_df.empty else None),
                    ...
                    "vw_outside_range_pct_of_vw_median": json_ready(vw_problem_df["vw_outside_range_pct_of_vw"].median() if not vw_problem_df.empty else None),
