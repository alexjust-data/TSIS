...
def main() -> None:
    ...
    ap.add_argument(
        "--universe",
        default=r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026_upper_excluding_ohlcv_1m_missing_vs_daily_ge_2B_or_null.parquet",
    )
    ap.add_argument(
        "--lifecycle",
        default=r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\official_lifecycle_compiled.csv",
    )
