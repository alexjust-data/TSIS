...
CALENDAR_CSV = Path(
    globals().get(
        "CALENDAR_CSV",
        r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\market_calendar_official_XNYS_20050101_20251231.csv",
    )
)
AUDIT_DIR = Path(
    globals().get(
        "AUDIT_DIR",
        r"C:\TSIS_Data\02_backtest_SmallCaps\runs\debug\audit_ohlcv_1m_hours",
    )
)
