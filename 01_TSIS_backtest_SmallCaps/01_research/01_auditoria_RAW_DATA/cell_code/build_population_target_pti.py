...
UNIVERSE_PTI_ROOT = Path(
    globals().get(
        "UNIVERSE_PTI_ROOT",
        r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_panel_pti",
    )
)
...
OUT_BASE = Path(
    globals().get(
        "OUT_BASE",
        r"C:\TSIS_Data\02_backtest_SmallCaps\runs\backtest\population_target_pti",
    )
)
