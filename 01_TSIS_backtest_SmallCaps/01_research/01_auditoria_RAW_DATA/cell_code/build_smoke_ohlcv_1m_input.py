...
if __name__ == "__main__":
    SOURCE_PARQUET = Path(
        r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_missing_in_ohlcv_1m_vs_daily.parquet"
    )
    OUTPUT_PARQUET = Path(
        r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_missing_in_ohlcv_1m_vs_daily_smoke.parquet"
    )
    TICKERS = ["AAPL", "ABT"]
