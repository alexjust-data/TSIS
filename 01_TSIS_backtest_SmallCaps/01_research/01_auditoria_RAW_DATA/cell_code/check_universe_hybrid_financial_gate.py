...
def main() -> None:
    p_tickers = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026.parquet")
    p_tickers_upper = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026_upper.parquet")
    p_hybrid = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched\universe_hybrid_enriched.parquet")
    ...
    outdir = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\runs\data_quality\00_data_certification")
    ...
    close_candidates = [
        Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\additional\day_aggs_v1"),
        Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\additional\ohlcv_daily"),
