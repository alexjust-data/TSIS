param(
  ...
  [string]$ScriptPath = "C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\build_trades_lt_1b_master_from_ohlcv_windows.py",
...
Write-Host "Running build_trades_lt_1b_master_from_ohlcv_windows..." -ForegroundColor Cyan
