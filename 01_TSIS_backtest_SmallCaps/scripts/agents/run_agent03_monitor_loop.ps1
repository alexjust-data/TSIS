...
$runDir = "C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\$RunId"
...
OFFICIAL_LIFECYCLE_CSV = Path(r'C:\TSIS_Data\02_backtest_SmallCaps\data\reference\official_lifecycle_compiled.csv')
...
if EVENTS_CSV.exists():
    s036 = Path(r'C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\036_agent3_quotes_coverage_and_causes.py')
    exec(s036.read_text(encoding='utf-8'), globals())

    s037 = Path(r'C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\037_agent3_diagnostics_tables_hist.py')
    ...
    if bool($($Run043.IsPresent)):
        ...
        TOP_N_WORST = 20
        FIGSIZE = (12, 4)
        s043 = Path(r'C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\043_dtype_rounding_plots.py')
    ...
    if bool($($Run038.IsPresent)):
        ...
        FIGSIZE = (12, 5)
        s038 = Path(r'C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\038_bid_ask_cross_deviation_metrics.py')
