...
DEFAULT_RAW_1M_QUALITY_MANIFEST = Path(
    r"C:\TSIS_Data\01_TSIS_backtest_SmallCaps\01_foundations\inspection_dossiers\minute\evidence_assets\core_quality\minute_core_quality_manifest_v0_1.parquet"
)
