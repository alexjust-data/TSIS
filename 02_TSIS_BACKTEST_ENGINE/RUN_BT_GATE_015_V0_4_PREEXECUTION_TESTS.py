"""Focused non-physical tests for the exact BT-GATE-015 V0.4 path."""
...
if count != 24:
    raise SystemExit(f"UNEXPECTED_BT_GATE_015_V0_4_TEST_COUNT={count}")
result = unittest.TextTestRunner(verbosity=2).run(suite)
print(f"BT_GATE_015_V0_4_PREEXECUTION_TEST_COUNT={count}")
