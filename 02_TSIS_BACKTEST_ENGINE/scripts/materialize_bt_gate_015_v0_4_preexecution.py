"""Derive the BT-GATE-015 V0.4 config and state from one semantic spec."""
...
AUTH_DOCUMENT = (
    ENGINE_ROOT
    / "docs/00_system/"
    "28_BT_GATE_015_SINGLE_USE_PHYSICAL_CONSUMER_AUTHORIZATION_V0_4.md"
)
...
def main() -> int:
    ...
    if spec["status"] != "AUTHORIZED_NOT_CONSUMED":
        raise SystemExit("V0.4 semantic spec is not intact")
    ...
    config = {
        ...
        "barrier_fixture_relative_path": "02_TSIS_BACKTEST_ENGINE/configs/fixtures/BT_GATE_015_PHYSICAL_INTEGRATION_BARRIERS_V0_4.json",
