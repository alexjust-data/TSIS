...
SPEC_PATH = ENGINE_ROOT / "configs/authorizations/bt_gate_015_single_use_physical_event_state_consumer_v0_3_spec.json"
...
def main() -> int:
    ...
    paths.update(
        {
            "02_TSIS_BACKTEST_ENGINE/RUN_BT_GATE_015_PHYSICAL_V0_3.py",
            "02_TSIS_BACKTEST_ENGINE/RUN_BT_GATE_015_V0_3_PREEXECUTION_TESTS.py",
            ...
            "02_TSIS_BACKTEST_ENGINE/configs/authorizations/bt_gate_015_single_use_physical_event_state_consumer_v0_3_spec.json",
            "02_TSIS_BACKTEST_ENGINE/configs/runs/bt_gate_015_single_use_physical_event_state_consumer_v0_3.json",
            "02_TSIS_BACKTEST_ENGINE/configs/fixtures/BT_GATE_015_PHYSICAL_INTEGRATION_BARRIERS_V0_3.json",
            "02_TSIS_BACKTEST_ENGINE/docs/00_system/20_BT_GATE_015_POINT_IN_TIME_EVENT_STATE_CONSUMER_CONTRACT_V0_1.md",
            "02_TSIS_BACKTEST_ENGINE/docs/00_system/23_BT_GATE_015_SINGLE_USE_PHYSICAL_CONSUMER_AUTHORIZATION_V0_3.md",
            "02_TSIS_BACKTEST_ENGINE/docs/00_system/24_BT_GATE_015_V0_3_PREEXECUTION_REVIEW_REQUEST.md",
            "02_TSIS_BACKTEST_ENGINE/docs/00_system/25_BT_GATE_015_V0_3_PREEXECUTION_PACKET_READOUT.md",
            "02_TSIS_BACKTEST_ENGINE/scripts/materialize_bt_gate_015_v0_3_preexecution.py",
            "02_TSIS_BACKTEST_ENGINE/scripts/package_bt_gate_015_v0_3_preexecution.py",
            "02_TSIS_BACKTEST_ENGINE/src/tsis_backtest/event_state/physical_authorization_v0_3.py",
            "02_TSIS_BACKTEST_ENGINE/src/tsis_backtest/event_state/physical_consumer_v0_3.py",
            "02_TSIS_BACKTEST_ENGINE/src/tsis_backtest/event_state/physical_runner_v0_3.py",
            "02_TSIS_BACKTEST_ENGINE/tests/unit/test_bt_gate_015_single_use_physical_v0_3.py",
        }
    )
    ...
    if (ENGINE_ROOT / "runs" / RUN_ID).exists():
        raise RuntimeError("V0.3 physical run directory must be absent")
    ...
    for relative in sorted(paths):
        ...
        if f"/runs/{RUN_ID}/" in f"/{normalized}/":
            raise RuntimeError(f"physical V0.3 run evidence prohibited: {relative}")
    ...
    output = ENGINE_ROOT / "deliverables" / (
        f"bt_gate_015_single_use_physical_preexecution_packet_v0_3_corrected_r2_{stamp}.zip"
    )
    manifest = {
        "package_id": "BT_GATE_015_SINGLE_USE_PHYSICAL_PREEXECUTION_PACKET_V0_3",
        "status": "PENDING_EXTERNAL_PREEXECUTION_REVIEW",
        "bt_gate_015": "NON_PHYSICAL_IMPLEMENTATION_ACCEPTED_PENDING_V0_3_PREEXECUTION_EXTERNAL_REVIEW",
        ...
        "focused_suite": "21/21 PASS",
        "full_repository_suite": "256/256 PASS",
        ...
        "physical_binding_correction": "CORRECTED_R2_PENDING_EXTERNAL_PREEXECUTION_REVIEW",
