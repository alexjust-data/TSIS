"""Only authorized CLI entry point for the BT-GATE-014 V0.3 physical run."""
...
from tsis_backtest.market_state.physical_authorization_v0_3 import (  # noqa: E402
    AUTHORIZATION_ID,
    CONFIG_RELATIVE_PATH,
    DOCUMENT_RELATIVE_PATH,
    AuthorizationV03,
)
from tsis_backtest.market_state.physical_runner_v0_3 import (  # noqa: E402
    PhysicalRunnerV03,
)
...
def main() -> None:
    ...
    result = PhysicalRunnerV03().execute(
        TSIS_ROOT,
        configuration,
        AuthorizationV03(STATE_PATH),
