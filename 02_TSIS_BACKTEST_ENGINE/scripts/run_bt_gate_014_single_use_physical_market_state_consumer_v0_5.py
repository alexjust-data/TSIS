"""Only authorized CLI entry point for the BT-GATE-014 V0.5 physical run."""
...
from tsis_backtest.market_state.physical_authorization_v0_5 import (  # noqa: E402
    AUTHORIZATION_ID,
    CONFIG_RELATIVE_PATH,
    DOCUMENT_RELATIVE_PATH,
    AuthorizationV05,
)
from tsis_backtest.market_state.physical_runner_v0_5 import (  # noqa: E402
    PhysicalRunnerV05,
)
...
STATE_PATH = (
    ...
    "bt_gate_014_single_use_physical_consumer_authorization_v0_5.json"
)
...
def main() -> None:
    ...
    result = PhysicalRunnerV05().execute(
        TSIS_ROOT,
        configuration,
        AuthorizationV05(STATE_PATH),
