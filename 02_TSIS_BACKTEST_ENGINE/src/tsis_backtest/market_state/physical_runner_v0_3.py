...
BARRIER_FIXTURE_RELATIVE_PATH = (
    "configs/fixtures/BT_GATE_014_PHYSICAL_INTEGRATION_BARRIERS_V0_3.json"
)
...
class BoundedPhysicalMarketStateEventLoopV03:
...
class PhysicalRunnerV03:
    ...
    def _after_consumption(
        ...
        _write_json(progress_path, {
            ...
            "validation_phase_reached": "CANDIDATE_PARQUET_OPEN",
        })
        rows = [
        ...
        event_loop = BoundedPhysicalMarketStateEventLoopV03(
            self.consumer
        )
        ...
        artifacts = {
            ...
            "physical_consumer_validation_report.json": {
                ...
                "event_loop_id": (
                    "BOUNDED_PHYSICAL_MARKET_STATE_EVENT_LOOP_V0_3"
                ),
                "identity_fingerprint_mismatches": 0,
