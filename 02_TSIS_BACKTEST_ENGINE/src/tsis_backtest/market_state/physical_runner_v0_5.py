...
from .physical_authorization_v0_5 import (
    AUTHORIZATION_ID,
    CONSUMER_ID,
...
PROVIDER_RELATIVE_PATHS = {
    "restriction_domain_binding": (
        ...
        "market_state_restriction_domain_binding_clarification_v0_1.json"
    ),
    "binding": (
        "00_CTO_APPLIED_ARCHITECTURE/03_TABLES_feature_engineering/"
        "09_STATE_CONSUMPTION_BOUNDARY/"
...
PHYSICAL_INPUT_SHA256 = {
    "restriction_domain_binding": "b3ebace6fab7cb0a690be165f0a1706a5906dc7a729488fa1139af00c02e53a9",
...
BARRIER_FIXTURE_RELATIVE_PATH = (
    "configs/fixtures/BT_GATE_014_PHYSICAL_INTEGRATION_BARRIERS_V0_5.json"
)
...
PRODUCTION_SPEC = FrozenPhysicalRunSpec(
    ...
    barrier_fixture_sha256=(
        "5a54527119a74eaf1917fda86db4216b45fb725c02da8c76e5fb2bbc993fb785"
    ),
)
...
CONFIG_FIELDS = {
    ...
    "production",
    "provider_relative_paths",
    "restriction_domain_binding_id",
    "restriction_domain_binding_sha256",
    "run_directory",
    "run_id",
    "strategy",
}
...
class BoundedPhysicalMarketStateEventLoopV05:
...
class PhysicalRunnerV05:
    ...
    def validate_preconsumption(
        ...
        if (
            ...
            raise MarketStateContractError(
                ...
                "exactly ten governed physical and metadata inputs required",
            )
    ...
    def execute(
        ...
        tsis_root: Path | str,
        configuration: Mapping[str, Any],
        authorization: AuthorizationV05,
        bindings: Mapping[str, str],
    ) -> dict[str, Any]:
    ...
    def _after_consumption(
        ...
        progress["restriction_diagnostics"] = {
            "replay_consumption_restrictions": list(EXPECTED_RESTRICTIONS),
            "restriction_domain_binding_sha256": "b3ebace6fab7cb0a690be165f0a1706a5906dc7a729488fa1139af00c02e53a9",
        ...
        event_loop = BoundedPhysicalMarketStateEventLoopV05(
            self.consumer
        )
        ...
        artifacts = {
            ...
            "physical_consumer_validation_report.json": {
                ...
                "event_loop_id": (
                    "BOUNDED_PHYSICAL_MARKET_STATE_EVENT_LOOP_V0_5"
                ),
                "identity_fingerprint_mismatches": 0,
