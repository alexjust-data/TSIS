...
from tsis_backtest.market_state.physical_authorization_v0_3 import (
    AUTHORIZATION_ID,
    CONSUMED_STATUS,
    CONSUMER_ID,
...
from tsis_backtest.market_state.physical_runner_v0_3 import (
    CONFIG_FIELDS,
...
class PhysicalV03Tests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        write_json(
            self.barrier_path,
            {
                ...
                "fixture_id": (
                    "BT_GATE_014_PHYSICAL_INTEGRATION_BARRIERS_V0_3"
                ),
    ...
    def execute(
        ...
        *,
        reader: Mock | None = None,
        authorization: AuthorizationV03 | None = None,
        configuration: dict | None = None,
    ) -> dict:
        return self.runner(rows, reader=reader).execute(
            self.tsis_root,
            configuration or self.configuration,
            authorization or AuthorizationV03(self.state_path),
            self.bindings,
        )
    ...
    def test_receipt_write_failure_is_durably_evidenced(self) -> None:
        ...
        authorization = AuthorizationV03(self.state_path)
        with patch.object(
            authorization,
            "_write_receipt",
    ...
    def test_state_transition_failure_keeps_armed_guard(self) -> None:
        import tsis_backtest.market_state.physical_authorization_v0_3 as auth_module
