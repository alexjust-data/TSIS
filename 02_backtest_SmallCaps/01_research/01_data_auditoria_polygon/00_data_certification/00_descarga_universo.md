...
# ejecuto comandos
python C:\TSIS_Data\02_backtest_SmallCaps\scripts\build_universe_pti.py 
   --start 2005-01-01 --end 2025-12-31 
   --outdir C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti 
   --frequency daily 
   --active-filter all 
...
outdir   : C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti
all      : C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_all.parquet
active   : C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_active.parquet
inactive : C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_inactive.parquet
qa       : C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\qa_coverage_by_cut.csv
...
# verifico
python C:\TSIS_Data\02_backtest_SmallCaps\scripts\agent_universe_audit.py 
--outdir C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti 
--stale-minutes 10 
--validate-latest-checkpoints 50 
--out-report-json C:\TSIS_Data\02_backtest_SmallCaps\runs\data_quality\00_data_certification\universe_audit_final_after_cleanup.json
...
# launcher
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\build_universe_hybrid_enriched.py 
   --input C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026.parquet 
   --outdir C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched 
   --batch-size 200 
   --resume
...
C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\build_universe_hybrid_enriched.py:288: FutureWarning: The behavior of DataFrame concatenation with empty or all-NA entries is deprecated. In a future version, this will no longer exclude empty or all-NA columns when determining the result dtypes. To retain the old behavior, exclude the relevant entries before the concat operation.
  asof = pd.concat(frames, ignore_index=True)
rows=15,979
saved=C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched\universe_hybrid_enriched.parquet
qa=C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched\universe_hybrid_enriched.qa.csv
coverage:
...
1. Catálogo de inactivos directo desde Polygon:
   ...
   - Se guarda en: C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched\inactive_catalog.parquet
...
Nuevos flags:
   ...
   C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\build_universe_hybrid_enriched.py:394: 
   ...
   python -c "
      import pandas as pd; 
      d=pd.read_parquet(r'C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched\universe_hybrid_enriched.parquet'); 
...
python C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\download_fundamentals_v1.py 
   --input C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026.parquet 
