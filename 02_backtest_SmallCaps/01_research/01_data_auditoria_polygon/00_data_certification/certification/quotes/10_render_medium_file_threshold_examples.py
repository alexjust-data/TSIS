...
CASES = [
    {
        "name": "09_medium_file_threshold_halt_context_bjdx_2024_12_12",
        "title": "BJDX | 2024-12-12 | medium_file_threshold_edge_hard_many_crosses | halt context but still bad",
        "file": r"D:\quotes\BJDX\year=2024\month=12\day=12\quotes.parquet",
        "window": 600,
        "halt_start_et": "2024-12-12 15:48:14",
        "resume_trade_et": "2024-12-12 16:00:00",
    },
    {
        "name": "10_medium_file_threshold_halt_context_gte_2005_08_01",
        "title": "GTE | 2005-08-01 | medium_file_threshold_edge_hard_many_crosses | halt context but still bad",
        "file": r"D:\quotes\GTE\year=2005\month=08\day=01\quotes.parquet",
        "window": 600,
        "halt_start_et": "2005-08-01 10:03:41",
        "resume_trade_et": "2005-08-01 11:16:05",
    },
    {
        "name": "11_medium_file_threshold_unexplained_ufab_2023_03_09",
        "title": "UFAB | 2023-03-09 | medium_file_threshold_edge_hard_many_crosses | not strongly explained",
        "file": r"C:\TSIS_Data\data\quotes\UFAB\year=2023\month=03\day=09\quotes.parquet",
        "window": 600,
    },
    {
        "name": "12_medium_file_threshold_unexplained_dgly_2011_10_06",
        "title": "DGLY | 2011-10-06 | medium_file_threshold_edge_hard_many_crosses | not strongly explained",
        "file": r"C:\TSIS_Data\data\quotes\DGLY\year=2011\month=10\day=06\quotes.parquet",
        "window": 600,
    },
]
