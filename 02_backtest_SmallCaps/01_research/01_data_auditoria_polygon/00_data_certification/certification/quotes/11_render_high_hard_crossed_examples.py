...
CASES = [
    {
        "name": "13_high_hard_crossed_halt_context_ctnt_2024_05_20",
        "title": "CTNT | 2024-05-20 | high_hard_crossed_10_to_20 | halt context but still bad",
        "file": r"D:\quotes\CTNT\year=2024\month=05\day=20\quotes.parquet",
        "window": 800,
        "halt_start_et": "2024-05-20 11:27:37",
        "resume_trade_et": "2024-05-20 16:00:00",
    },
    {
        "name": "14_high_hard_crossed_halt_context_dna_2005_03_14",
        "title": "DNA | 2005-03-14 | high_hard_crossed_10_to_20 | halt context but still bad",
        "file": r"D:\quotes\DNA\year=2005\month=03\day=14\quotes.parquet",
        "window": 800,
        "halt_start_et": "2005-03-14 15:25:57",
        "resume_trade_et": "2005-03-14 15:45:41",
    },
    {
        "name": "15_high_hard_crossed_unexplained_sgc_2013_11_04",
        "title": "SGC | 2013-11-04 | high_hard_crossed_10_to_20 | not strongly explained",
        "file": r"D:\quotes\SGC\year=2013\month=11\day=04\quotes.parquet",
        "window": 800,
    },
    {
        "name": "16_high_hard_crossed_unexplained_self_2016_06_28",
        "title": "SELF | 2016-06-28 | high_hard_crossed_10_to_20 | not strongly explained",
        "file": r"C:\TSIS_Data\data\quotes\SELF\year=2016\month=06\day=28\quotes.parquet",
        "window": 800,
    },
]
