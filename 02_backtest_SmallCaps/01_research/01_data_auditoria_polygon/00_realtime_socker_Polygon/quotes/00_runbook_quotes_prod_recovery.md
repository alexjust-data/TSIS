...
- `RUN_DIR = C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\20260313_quotes_prod_full_12133_clean`
...
- `C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\20260313_quotes_prod_full_12133_clean\inputs\tasks_quotes_prod.csv`
...
- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\download_quotes.py`

Launcher real:

- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_agent01_quotes.ps1`
...
- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_agent02_quotes.ps1`
...
- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_agent03_quotes.ps1`
- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\run_agent03_monitor_compact.ps1`
- `C:\TSIS_Data\02_backtest_SmallCaps\data_auditoria_polygon\cell_code\00_data_certification\036_agent3_quotes_coverage_and_causes.py`
...
- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\run_agent_supervisor.ps1`

Launcher real:

- `C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_supervisor_quotes.ps1`
...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_agent01_quotes.ps1" -RunId "20260313_quotes_prod_full_12133_clean" -CsvPath "C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\20260313_quotes_prod_full_12133_clean\inputs\tasks_quotes_prod.csv"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_agent02_quotes.ps1" -RunId "20260313_quotes_prod_full_12133_clean" -MaxFiles 50000
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_agent03_quotes.ps1" -RunId "20260313_quotes_prod_full_12133_clean"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\TSIS_Data\02_backtest_SmallCaps\scripts\agents\launch_prod_supervisor_quotes.ps1" -RunId "20260313_quotes_prod_full_12133_clean"
```
