...
BASE = Path(globals().get("BASE", r"C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\granular_strict"))
EVENTS_CSV = Path(globals().get("EVENTS_CSV", r"C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\quotes_agent_strict_events.csv"))
RETRY_CSV = Path(globals().get("RETRY_CSV", r"C:\TSIS_Data\02_backtest_SmallCaps\runs\polygon_realtime_audit\retry_queue_quotes_strict.csv"))
