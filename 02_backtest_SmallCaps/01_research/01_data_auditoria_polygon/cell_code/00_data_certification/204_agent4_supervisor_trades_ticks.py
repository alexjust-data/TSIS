...
def main() -> None:
    ...
    while True:
        ...
        if s2 is None:
            ...
            print(f"  validated_found  : {s2.get('validated_found_current', s2.get('expected_tasks_found_current'))}")
            print(f"  downloaded_ok    : {s2.get('downloaded_ok_current', 'N/A')}")
            print(f"  expected_empty   : {s2.get('expected_tasks_empty_current')}")
            print(f"  expected_missing : {s2.get('expected_tasks_missing_current')}")
