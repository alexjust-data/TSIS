...
DEFAULT_ALL = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_all.parquet")
DEFAULT_OUT = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026.parquet")
