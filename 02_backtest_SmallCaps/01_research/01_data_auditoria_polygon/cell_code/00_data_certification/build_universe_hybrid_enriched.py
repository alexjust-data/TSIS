...
def main() -> None:
    ...
    ap.add_argument(
        "--input",
        default=r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_2005_2026.parquet",
    )
    ap.add_argument(
        "--outdir",
        default=r"C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\hybrid_enriched",
    )
