...
DEFAULT_OUT_ROOT = Path(r"C:\TSIS_Data\02_backtest_SmallCaps\runs\backtest\trades_lt_1b_tasks")


def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Construye task master de trades desde ventanas observadas en ohlcv_daily")
...
def main() -> int:
    ...
    if args.outdir:
        ...
        outdir = DEFAULT_OUT_ROOT / f"{stamp}_build_trades_lt_1b_master_from_ohlcv_windows"
    ...
    tasks_csv = outdir / "tasks_trades_lt_1b_master.csv"
    tasks_parquet = outdir / "tasks_trades_lt_1b_master.parquet"
    summary_csv = outdir / "tasks_trades_lt_1b_summary_by_ticker.csv"
    manifest_json = outdir / "tasks_trades_lt_1b_manifest.json"
