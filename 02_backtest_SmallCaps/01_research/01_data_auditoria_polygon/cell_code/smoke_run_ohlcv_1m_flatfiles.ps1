...
$Input = "C:\TSIS_Data\02_backtest_SmallCaps\data\reference\universe_pti\tickers_missing_in_ohlcv_1m_vs_daily_smoke.parquet"
...
$FlatOptsPath = "C:\TSIS_Data\02_backtest_SmallCaps\runs\debug\smoke_flatfiles_storage_options.json"
