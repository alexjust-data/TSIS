param(
  ...
  [string]$PingMasterParquet = "C:\TSIS_Data\02_backtest_SmallCaps\data\reference\ping_range_master.parquet",
  [string]$DownloaderScript = "C:\TSIS_Data\02_backtest_SmallCaps\scripts\download_quotes.py",
