...
Estamos trabajando en `C:/TSIS_Data/03_TSIS_Lab`, dentro del marco nuevo de TSIS como Scientific Discovery Engine.
...
```text
C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0002
```
...
```text
C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0002/evidence/scanner_2026_qg_full_universe_full_v0_2_20260707T164416Z
```
...
```text
C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0002/scripts/build_das_frontside_anchor_candidates_from_worklist_v0_1.py
```
...
```text
C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0002/scripts/build_2026_scanner_from_qg_full_universe_1m_v0_2.py
```
...
```text
C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0002/scripts/run_scanner_2026_qg_full_universe_monitored_v0_2.py
```
...
```text
C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0002/scripts/render_das_frontside_anchor_candidates_v0_2.py
```
