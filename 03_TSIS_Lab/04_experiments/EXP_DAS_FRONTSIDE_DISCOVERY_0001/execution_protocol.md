...
Contrato base: `C:/TSIS_Data/03_TSIS_Lab/01_contracts/research_experiment_execution_protocol_v0_1.md`
...
```powershell
python C:/TSIS_Data/03_TSIS_Lab/05_executors/run_research_experiment.py `
  --experiment-root C:/TSIS_Data/03_TSIS_Lab/04_experiments/EXP_DAS_FRONTSIDE_DISCOVERY_0001 `
...
```text
C:/TSIS_Data/03_TSIS_Lab/06_validators/validate_visual_inspection_manifest.py
```

Uso esperado sobre un run:

```powershell
python C:/TSIS_Data/03_TSIS_Lab/06_validators/validate_visual_inspection_manifest.py `
  --run-dir <run_dir> `
  --write-report
```
