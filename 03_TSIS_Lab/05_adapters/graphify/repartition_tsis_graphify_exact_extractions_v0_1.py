...
def main() -> int:
    ...
    if added_paths or changed_paths or unauthorized_removals or not removed_paths:
        raise ValueError(
            "Delta contains an unauthorized corpus change: "
            f"added={added_paths}, changed={changed_paths}, "
    ...
    evidence = {
        "schema_version": "TSIS_GRAPHIFY_EXACT_EXTRACTION_REPARTITION_v0_1",
