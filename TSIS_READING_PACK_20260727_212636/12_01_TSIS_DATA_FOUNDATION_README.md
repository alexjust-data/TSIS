...
Modulo de Data Foundation SmallCaps: auditoria, certificacion de datos, formalizacion de estados de mercado, contratos, policies, validators, dossiers e institucionalidad de datos para TSIS.

Este modulo es la capa de datos gobernados y memoria cientifica preservada de TSIS para microcaps y small caps. No es el motor profesional de backtest.

Su funcion es:

- construir datasets y universos historicos defendibles;
- auditar y certificar calidad de market data;
- formalizar features, eventos, estados y objetos de research como contratos consumibles;
- producir evidencia reproducible para promocion, cuarentena o descarte;
- soportar capas downstream de backtest, live, Lab, ML y offline RL sin redefinir silenciosamente semantica upstream.

El path anterior `C:/TSIS_Data/01_TSIS_backtest_SmallCaps` se resuelve ahora como `C:/TSIS_Data/01_TSIS_DATA_FOUNDATION`. La tabla completa vive en `C:/TSIS_Data/PATH_MIGRATION_2026_07_22.md`.
