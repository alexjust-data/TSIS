...
```text
Polygon/Massive prototype evidence: C:/TSIS_Data/04_TSIS_webSocket_SmallCaps/data/raw_ws
Polygon/Massive curated prototype outputs: C:/TSIS_Data/04_TSIS_webSocket_SmallCaps/data/curated_ws
```
