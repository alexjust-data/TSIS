...
## Corpus Check
- 45 files · ~95,358 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 57 nodes · 252 edges · 9 communities
- Extraction: 1% EXTRACTED · 99% INFERRED · 0% AMBIGUOUS · INFERRED: 249 edges (avg confidence: 0.86)
...
- [[_COMMUNITY_Graph Cluster 8|Graph Cluster 8]]
...
- `README` --defines_or_references--> `Project Operating System`  [INFERRED]
  00_CTO/README.md → PROJECT_OPERATING_SYSTEM.md
...
Cohesion: 0.42
Nodes (12): GRAPHIFY_OFFICIAL_BUILD_PROTOCOL, GRAPHIFY_REFRESH_QUEUE, LOCAL_RULES, README, GRAPHIFY_OFFICIAL_BUILD_PROTOCOL, GRAPHIFY_REFRESH_QUEUE, LOCAL_RULES, README (+4 more)

### Community 1 - "Graph Cluster 1"
Cohesion: 0.25
Nodes (8): 00_privado, knowledge_object_promotion_contract_v0_1, parameter_sweep_protocol_v0_1, knowledge_object_registry_v0_1, research_experiment_registry_v0_1, evidence_report_template, README, Dirty Working Tree Snapshot

### Community 2 - "Graph Cluster 2"
Cohesion: 0.48
Nodes (7): README, research_experiment_execution_protocol_v0_1, AGENTS, CHANGELOG, README, CTO Architecture, Minute Data Uses E:/TSIS Root
...
Cohesion: 0.40
Nodes (5): README, research_experiment_contract_v0_1, README, VERSIONING_STANDARDS, Agent Rules

### Community 5 - "Graph Cluster 5"
Cohesion: 0.40
Nodes (5): CHANGELOG, 01_privado2, README, LONG_RUNNING_OPERATIONS_CONTRACT, Project Operating System

### Community 6 - "Graph Cluster 6"
Cohesion: 0.40
Nodes (5): scientific_validation_pipeline_contract_v0_1, AGENTS, PROJECT_RULES, RESEARCH_PHILOSOPHY, Long Running Operations

### Community 7 - "Graph Cluster 7"
Cohesion: 0.40
Nodes (5): README, research_design, data_sources, CHANGELOG, Market Science

### Community 8 - "Graph Cluster 8"
Cohesion: 0.40
Nodes (5): execution_bridge, README, LOCAL_RULES, PROJECT_OPERATING_SYSTEM, Data Foundation Module
...
- **Why does `Dirty Working Tree Snapshot` connect `Graph Cluster 1` to `Graph Cluster 0`, `Graph Cluster 2`, `Graph Cluster 3`, `Graph Cluster 4`, `Graph Cluster 5`, `Graph Cluster 6`, `Graph Cluster 7`, `Graph Cluster 8`?**
  _High betweenness centrality (0.413) - this node is a cross-community bridge._
- **Why does `CTO Architecture` connect `Graph Cluster 2` to `Graph Cluster 0`, `Graph Cluster 1`, `Graph Cluster 3`, `Graph Cluster 4`, `Graph Cluster 5`, `Graph Cluster 6`, `Graph Cluster 7`, `Graph Cluster 8`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `Agent Rules` connect `Graph Cluster 4` to `Graph Cluster 0`, `Graph Cluster 2`, `Graph Cluster 3`, `Graph Cluster 5`, `Graph Cluster 6`, `Graph Cluster 8`?**
